...
#define LOG_TRACE_TO(logger, ...)                                                                                      \
    Nilib::LoggerPool::instance().name(logger)->level(::Nilib::LogLevel::Trace).output(__VA_OPT__(__VA_ARGS__))
#define LOG_TRACE(...)                                                                                                 \
    Nilib::LoggerPool::instance().global()->level(Nilib::LogLevel::Trace).output(__VA_OPT__(__VA_ARGS__))
#else
...
#define LOG_DEBUG_TO(logger, ...)                                                                                      \
    Nilib::LoggerPool::instance()                                                                                      \
        .name(logger)                                                                                                  \
        ->level(::Nilib::LogLevel::Debug)                                                                              \
        .userblock(__VA_OPT__(Nilib::LogLevel::Debug))                                                                 \
        .output(__VA_OPT__(__VA_ARGS__))
#define LOG_DEBUG(...)                                                                                                 \
    Nilib::LoggerPool::instance()                                                                                      \
        .global()                                                                                                      \
        ->level(Nilib::LogLevel::Debug)                                                                                \
...
#define LOG_INFO_TO(logger, ...)                                                                                       \
    Nilib::LoggerPool::instance()                                                                                      \
        .name(logger)                                                                                                  \
        ->level(::Nilib::LogLevel::Info)                                                                               \
        .userblock(__VA_OPT__(Nilib::LogLevel::Info))                                                                  \
        .output(__VA_OPT__(__VA_ARGS__))
#define LOG_INFO(...)                                                                                                  \
    Nilib::LoggerPool::instance()                                                                                      \
        .global()                                                                                                      \
...
#define LOG_WARNING_TO(logger, ...)                                                                                    \
    Nilib::LoggerPool::instance()                                                                                      \
        .name(logger)                                                                                                  \
        ->level(::Nilib::LogLevel::Warning)                                                                            \
        .userblock(__VA_OPT__(Nilib::LogLevel::Warning))                                                               \
        .output(__VA_OPT__(__VA_ARGS__))
#define LOG_WARNING(...)                                                                                               \
    Nilib::LoggerPool::instance()                                                                                      \
        .global()                                                                                                      \
...
#define LOG_SUCCESS_TO(logger, ...)                                                                                    \
    Nilib::LoggerPool::instance()                                                                                      \
        .name(logger)                                                                                                  \
        ->level(::Nilib::LogLevel::Success)                                                                            \
        .userblock(__VA_OPT__(Nilib::LogLevel::Success))                                                               \
        .output(__VA_OPT__(__VA_ARGS__))
#define LOG_SUCCESS(...)                                                                                               \
    Nilib::LoggerPool::instance()                                                                                      \
        .global()                                                                                                      \
...
#define LOG_ERROR_TO(logger, ...)                                                                                      \
    Nilib::LoggerPool::instance()                                                                                      \
        .name(logger)                                                                                                  \
        ->level(::Nilib::LogLevel::Error)                                                                              \
        .userblock(__VA_OPT__(Nilib::LogLevel::Error))                                                                 \
        .output(__VA_OPT__(__VA_ARGS__))
#define LOG_ERROR(...)                                                                                                 \
    Nilib::LoggerPool::instance()                                                                                      \
        .global()                                                                                                      \
...
#define LOG_PROGRESS_TO(logger, ...)                                                                                   \
    Nilib::LoggerPool::instance()                                                                                      \
        .name(logger)                                                                                                  \
        ->level(::Nilib::LogLevel::Progress)                                                                           \
        .userblock(__VA_OPT__(Nilib::LogLevel::Progress))                                                              \
        .output(__VA_OPT__(__VA_ARGS__))
#define LOG_PROGRESS(...)                                                                                              \
    Nilib::LoggerPool::instance()                                                                                      \
        .global()                                                                                                      \
