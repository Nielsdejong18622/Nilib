...
int main()
{
    ...
    renderer.submitQuad({{0.0f, 0.0f, 0.0f}, Colors::Red}, {{0.0f, -0.5f, 0.0f}, Colors::Green},
                        {{-0.5f, -0.5f, 0.0f}, Colors::Blue}, {{-0.5f, 0.0f, 0.0f}, Colors::Yellow});

    renderer.submitQuad({{0.0f, 0.0f, 0.0f}, Colors::Red}, {{0.0f, 1.f, 0.0f}, Colors::Green},
                        {{0.9f, 1.f, 0.0f}, Colors::Blue}, {{1.f, 0.0f, 0.0f}, Colors::Yellow});

    renderer.submitTriangle({{0.0f, 0.5f, 0.0f}, Colors::Cyan}, {{-0.2f, -0.5f, 0.0f}, Colors::Coral},
